...
public class Item implements Serializable{
	...
	/**
	  ...
	  */
	  ...
	  /**
	   * This method uses a Prepare statement object to query the ITEM table where ID matches the class field inumber
	   * to delte the specific item that the Admin desires to delete
	    **/
